# `feature/Sdk-validation-types` review triage — deferred findings of the first pass
...
**Reporter:** the bundled code-review (low), on `src/client.ts` (`runResultFailed` / `knownRunStatus`).
